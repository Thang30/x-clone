  ...
  return (
    <div className="">
      ...
      <div className="flex items-center gap-8 sticky top-0 backdrop-blur-md p-4 z-10 bg-[#00000084]">
        ...
        <h1 className="font-bold text-lg">Thang30</h1>
      </div>
      {/* INFO */}
      <div className="">
        ...
        <div className="p-4 flex flex-col gap-2">
          {/* USERNAME & HANDLE */}
          <div className="">
            <h1 className="text-2xl font-bold">Thang30</h1>
            <span className="text-textGray text-sm">@thang30</span>
          </div>
          <p>Thang30 LinkedIn</p>
          {/* JOB & LOCATION & DATE */}
